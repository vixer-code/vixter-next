      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <div className="hero-cta">
            <Link href="/auth/signup" className="btn-primary">Começar Agora</Link>
      ...
      <section className="services-section">
        ...
        <div className="services-grid">
          <div className="service-card">
            ...
            <Link href="/services?type=duo" className="btn-service">Encontrar Duo</Link>
          </div>
          ...
          <div className="service-card featured">
            ...
            <Link href="/vixies" className="btn-service">Conhecer Vixies</Link>
          </div>
          ...
          <div className="service-card">
            ...
            <Link href="/services?type=coaching" className="btn-service">Encontrar Coach</Link>
        </div>
          ...
          <div className="service-card">
            ...
            <Link href="/services?type=voice" className="btn-service">Iniciar Chat</Link>
          </div>
        </div>
      </section>
        ...
        <div className="vixies-slider">
          <div className="vixie-profile">
            ...
            <div className="vixie-info">
              ...
              <Link href="/vixie-profile?id=1" className="btn-view-profile">Ver Perfil</Link>
            </div>
          </div>
          ...
          <div className="vixie-profile">
            ...
            <div className="vixie-info">
              ...
              <Link href="/vixie-profile?id=2" className="btn-view-profile">Ver Perfil</Link>
            </div>
          </div>
          ...
          <div className="vixie-profile">
            ...
            <div className="vixie-info">
              ...
              <Link href="/vixie-profile?id=3" className="btn-view-profile">Ver Perfil</Link>
            </div>
          </div>
          ...
          <div className="vixie-profile">
            ...
            <div className="vixie-info">
              ...
              <Link href="/vixie-profile?id=4" className="btn-view-profile">Ver Perfil</Link>
            </div>
          </div>
        </div>
        
        <div className="view-all-container">
          <Link href="/vixies" className="btn-view-all">Ver Todas as Vixies</Link>
        </div>
      </section>
      ...
      <section className="join-section">
        <div className="join-content">
          ...
          <div className="join-cta">
            <Link href="/auth/signup" className="btn-primary-large">Criar Conta Grátis</Link>
            <Link href="/vixies" className="btn-secondary-large">Explorar Vixies</Link>
          </div>
        </div>
