...
export default function Register() {
  ...
  const handleAvatarChange = (avatarChoice: string) => {
    setFormData(prev => ({
      ...prev,
      avatarChoice
    }))
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError('Registro ainda não implementado. Use o Google Sign-In por enquanto.')
    setLoading(false)
  }
  ...
  const renderStep4 = () => (
    <form onSubmit={handleSubmit} className="auth-form">
        ...
        <div className="example-photo">
          ...
          <div className="photo-upload-item" id="doc-front-upload">
            <input 
              ...
              id="doc-front" 
              accept="image/*"
              onChange={(e) => handleDocumentChange('front', e.target.files?.[0] || null)}
            />
          ...
          <div className="photo-upload-item" id="doc-back-upload">
            <input 
              ...
              id="doc-back" 
              accept="image/*"
              onChange={(e) => handleDocumentChange('back', e.target.files?.[0] || null)}
            />
            <div className="photo-upload-icon">📄</div>
      ...
      <div className="form-footer step4-footer-section">
        <button type="button" className="btn secondary" onClick={prevStep}>Voltar</button>
        <button type="button" className="skip-verification" onClick={handleSubmit}>
